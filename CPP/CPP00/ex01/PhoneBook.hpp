...
/*   Updated: 2024/06/09 17:19:32 by Gfinet           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class PhoneBook
{
	private:
		...
		{
			std::cout << lst[i].get_first_name() << std::endl;
			std::cout << lst[i].get_last_name() << std::endl;
			std::cout << lst[i].get_nick_name() << std::endl;
			std::cout << lst[i].get_phone_number() << std::endl;
			std::cout << lst[i].get_dark_secret() << std::endl;
		};
    public:
